...
class Input 
{
	 ...
	 * @return mixed
	 */
	public static function post($var,$def=NULL)
	{
		return filter_has_var(INPUT_POST, $var) ? $_POST[$var] : $def;
	}
        public static function postJson($var,$def='')
        {
            if(Input::postHasVal($var)){
                $data = Input::post($var);
                return str_replace('"', '&ldquo;', $data);
            }
            else
            {
                return $def;
	...
	public static function postHasVal($var) 
	{
            if(Input::hasPost($var)){
                $val = Input::post($var);
                return ($val != NULL && $val != '');
            }else{
                return false;
	...
	public static function getHasVal($var) 
	{
            if(Input::hasGet($var)){
                $val = Input::get($var);
                return ($val != NULL && $val != '');
        ...
        public static function getHasNumeric($var){
            if(Input::getHasVal($var)){
                $val = Input::get($var);
